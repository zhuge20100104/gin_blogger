/*
 ...
 Date: 2/08/2020 16:54:50
*/
CREATE DATABASE blogger default charset=utf8mb4;
...
CREATE TABLE `comment`  (
  ...
  `create_time` timestamp(0) NOT NULL ON UPDATE CURRENT_TIMESTAMP(0) DEFAULT CURRENT_TIMESTAMP COMMENT '评论发布时间',
